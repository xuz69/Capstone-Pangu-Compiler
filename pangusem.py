...
symtab = SymbolTab() # create a symbol table object
is_attri = False

scope_stack = [] # used for building symbol table
scope_stack1 = [] # used for checking where and what type the variable is
...
# append new scope to scope stack if new scope is met
# insert symbol into symbol if a variable is defined and it passed the semantic checking (e.g do not redefined a variable)
...
# go over the AST to build the symbol table    
...
# check where the variable is defined and what type it is
