...
class Node:
    def __init__(self,nodeid,value=None):
        self.children = [] # list of children of the root node in the subtree
        self.nodeid = nodeid # id for the root node in the subtree
        self.value = value
        self.pline = 0
        self.ppos = 0
        self.type = ''
    ...
    # print the name of the non-terminal using ss method in xnames.py
    def xid(self):
        print(ss(self),end='')
    ...
    # print out how the AST is built, start from the root Node and go over each sub-AST recursively
    def showtree(self):
        self.show()
        for i in self.children:
            if i.leaf():
